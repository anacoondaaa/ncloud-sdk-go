...
var _ = Describe("Remove Nas Volume Access Control", func() {
	Describe("Remove Nas Volume Access Control", func() {
		BeforeEach(func() {
			gock.New("https://ncloud.apigw.ntruss.com").
				...
				Reply(http.StatusOK).BodyString(`
					...
					<requestId>a67e644d-8150-46ee-8fac-49f94a93b11a</requestId>
					...
					<nasVolumeInstanceList>
						<nasVolumeInstance>
							...
							<volumeUseSize>315392</volumeUseSize>
							...
							<nasVolumeInstanceCustomIpList>
								<nasVolumeInstanceCustomIp>
									<customIp>10.3.1.1</customIp>
								</nasVolumeInstanceCustomIp>
								<nasVolumeInstanceCustomIp>
									<customIp>10.3.2.1</customIp>
								</nasVolumeInstanceCustomIp>
							</nasVolumeInstanceCustomIpList>
		...
		It("should remove Nas Volume Access Control", func() {
			...
			result, err := conn.RemoveNasVolumeAccessControl(reqParams)
