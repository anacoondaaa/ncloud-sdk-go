...
func processSetNasVolumeAccessControlParams(reqParams *RequestSetNasVolumeAccessControl) (map[string]string, error) {
...
func (s *Conn) SetNasVolumeAccessControl(reqParams *RequestSetNasVolumeAccessControl) (*NasVolumeInstanceList, error) {
