...
type AddPortForwardingRulesResponseWrapper struct {
	AddPortForwardingRulesResponse AddPortForwardingRulesResponse `json:"addPortForwardingRulesResponse,omitempty"`
}
